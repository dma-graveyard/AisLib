 ...
 * 
 * An AIS position message is defined by ITU-R M.1371-4 in 
 * annex 8 - AIS messages section 3.1
 * 
 * This is a generalization for message types 1-3 and possibly
 * more in the future.
 * 
 * Type 1: Scheduled position report (Class A shipborne mobile equipment)
 * Type 2: Assigned scheduled position report (Class A shipborne mobile equipment)
 * Type 3: Special position report, response to interrogation;(Class A shipborne mobile equipment)
 * 
 */
public abstract class AisPositionMessage extends AisMessage {
	 ...
	 *      carrying dangerous goods (DG), harmful substances (HS) or 
	 ...
	 * Values between 0 and 708 degrees per min coded by
	...
	/**
	 * AisPosition Accuracy:
	 * The position accuracy (PA) flag should be determined in accordance with Table 47
	 * 1 = high ( =< 10 m)
	 * 0 = low (>10 m)
	 * 0 = default
	 */
	...
	/**
	 * SOTDMA/ITDMA sync state:
	 * sync state is part of the defined communication state (19) bits.
	 * The sync state is the first 2 bits of the 19 bits in the communication state
	 * of the message.
	 * 
	 ...
	 * is directly synchronized to a base station
	 */
