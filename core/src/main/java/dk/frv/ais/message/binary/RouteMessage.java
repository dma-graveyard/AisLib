...
/**
 * Abstract base class for all messages using route information
 * DAC=1,   FI=27,28
 * DAC=219, FI=1,2
 */
public abstract class RouteMessage extends AisApplicationMessage {
	...
	protected int duration; // 18 bits: Minutes until end of validity 0=cancel route	
	protected int waypointCount; // 5 bits: 0 - 16
	protected List<AisPosition> waypoints; // 55 bits each longitude 28 bit, latitude 27 bit
