...
public class RouteSuggestionReply extends AisApplicationMessage {
	...
	private int refMsgLinkId; // 10 bits: The Message Linkage ID of the message
								// responded to.
	/**
	 * 0 = Accept – Ship intends to adjust intended route 1 = Reject – Ship does
	 * not intend to adjust intended route 2 = Noted – Ship acknowledges
	 * reception, but cannot, or will not, consider the recommendation.
	 */
