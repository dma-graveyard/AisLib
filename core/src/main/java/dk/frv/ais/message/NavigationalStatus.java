...
private NavStatus navStatus;
	...
	public NavigationalStatus(int intNavStatus){
		navStatus = NavStatus.UNDEFINED;
			...
			switch(intNavStatus){
			case 0: navStatus = NavStatus.UNDER_WAY_USING_ENGINE; break;
			case 1: navStatus = NavStatus.AT_ANCHOR; break;
			case 2: navStatus = NavStatus.NOT_UNDER_COMMAND; break;
			case 3: navStatus = NavStatus.RESTRICTED_MANOEUVRABILITY; break;
			case 4: navStatus = NavStatus.CONSTRAINED_BY_HER_DRAUGHT; break;
			case 5: navStatus = NavStatus.MOORED; break;
			case 6: navStatus = NavStatus.AGROUND; break;
			case 7: navStatus = NavStatus.ENGAGED_IN_FISHING; break;
			case 8: navStatus = NavStatus.UNDER_WAY; break; 
			case 14: navStatus = NavStatus.AIS_SART; break; 
			case 15: navStatus = NavStatus.UNDEFINED; break; 
			}	
