...
public class AisMessage18 extends AisMessage implements IGeneralPositionMessage {
	...
	/**
	 * Class B display flag: 0 = No display available; not capable of displaying
	 * Message 12 and 14 1 = Equipped with integrated display displaying Message
	 * 12 and 14
	 */
	private int classBDisplayFlag; // 1 bit

	/**
	 * Class B DSC flag: 0 = Not equipped with DSC function 1 = Equipped with
	 * DSC function (dedicated or time-shared)
	 */
	private int classBDscFlag; // 1 bit

	/**
	 * Class B band flag: 0 = Capable of operating over the upper 525 kHz band
	 * of the marine band 1 = Capable of operating over the whole marine band
	...
	/**
	 * Communication state: SOTDMA communication state (see � 3.3.7.2.1, Annex
	 * 2), if communication state selector flag is set to 0, or ITDMA
	 * communication state (see � 3.3.7.3.2, Annex 2), if communication state
	 * selector flag is set to 1 Because Class B CS does not use any
	 * Communication State information, this field should be filled with the
