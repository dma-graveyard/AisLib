 ...
 * AIS message 18
 * 
 * CLASS B position report implemented according
 * to ITU-R M.1371-4
 * 
 */
public class AisMessage18 extends AisMessage {
	...
	/**
	 * RAIM-flag:
	 * RAIM (Receiver autonomous integrity monitoring) flag of electronic position fixing device;
	 * 0 = RAIM not in use = default;
	 * 1 = RAIM in use see Table 47
	 */
	...
	/**
	 * Communication state:
	 * SOTDMA communication state (see � 3.3.7.2.1, Annex 2), if
	 * communication state selector flag is set to 0, or ITDMA
	 * communication state (see � 3.3.7.3.2, Annex 2), if communication state
	 * selector flag is set to 1
	 * Because Class B CS does not use any Communication State
	 * information, this field should be filled with the following value:
	 * 1100000000000000110
	 */
