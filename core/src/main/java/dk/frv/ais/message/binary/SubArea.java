...
public class SubArea {
	...
	public String toString() {
		...
		case 0:
			subareaMessage = "( Circle, SF=" + getRawScaleFactor() + ", Pos = [" + getRawLatitude() + "," + getRawLongitude()
					+ "], Prec=" + getRawPrecision() + ", Radius=" + getRawRadius() + " )";
			break;
		case 1:
			subareaMessage = "( Rectangle, SF=" + getRawScaleFactor() + " Pos = [" + getRawLatitude() + "," + getRawLongitude()
					+ "], dim E=" + getRawEDim() + ", dim N=" + getRawNDim() + ", Orientation=" + getRawOrient() + " )";
			break;
		case 2:
		...
		case 3:
			subareaMessage = "( Polyline, SF=" + getRawScaleFactor() + " P1 A&D = [" + getRawP1Angle() + "," + getRawP1Dist()
					+ "], P2 A&D = [" + getRawP2Angle() + "," + getRawP2Dist() + "],P3 A&D = [" + getRawP3Angle() + ","
					+ getRawP3Dist() + "],P4 A&D = [" + getRawP4Angle() + "," + getRawP4Dist() + "])";
			break;
		case 4:
			subareaMessage = "( Polygon, SF=" + getRawScaleFactor() + " P1 A&D = [" + getRawP1Angle() + "," + getRawP1Dist()
					+ "], P2 A&D = [" + getRawP2Angle() + "," + getRawP2Dist() + "],P3 A&D = [" + getRawP3Angle() + ","
					+ getRawP3Dist() + "],P4 A&D = [" + getRawP4Angle() + "," + getRawP4Dist() + "])";
			break;
		case 5:
