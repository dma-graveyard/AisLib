 ...
 * 
 * Generally the position report is handled in the super class but there
 * are some specific purposes of this class. This is mainly the 
 * communication state field, that requires some special attention.
 * 
 * The communication state field covers 19 bits and this is general to 
 * both message 1, message 2 and message 3. The content is though different
 * for the different communication states applied by the different 
 * message types.
 * 
 ...
 * 
 * When slot timeout = 0 - Then the sub message is the slot offset:
 ...
 * 
 * When slot timeout = 2,4,6 - Then the sub message is the slot number:
 ...
 * currently is receiving (between 0 and 16383).
 *  
 */
public class AisMessage1 extends AisPositionMessage {
	...
	/**
	 * SOTDMA sub-message
	 * This field has many purposes see class description for help:
	 */
