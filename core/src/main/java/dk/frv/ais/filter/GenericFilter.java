 ...
 * 
 * A filter receives AIS messages, do some manipulation, and delivers messages
 * to a list of receivers. Hence filters can be put between an AIS source and
 * handlers.
 * 
 */
public abstract class GenericFilter implements IAisHandler {
	 ...
	 */
	private Set<IAisHandler> receivers = new HashSet<IAisHandler>();
