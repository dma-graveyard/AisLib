...
public interface ISendResultListener {
	...
	/**
	 * Returns received ABK. If no ABK is received within timeout null is
	 * returned.
	 * 
	 * Make this a simple method that only sets a status field or the like, as
	 * this method is run from the ABK handling thread.
	 * 
	 * @param abk
	 */
