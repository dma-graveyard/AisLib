...
public class EncodeTest {
	...
	public void rawEncodeDecodeTest() {
		...
		for (int i = 0; i < iterations; i++) {
			...
			List<Integer> bitLengths = new ArrayList<Integer>();
			List<Integer> values = new ArrayList<Integer>(fieldsCount);
	...
	public void aisEncode() throws SentenceException, SixbitException, AisMessageException {
		...
		Vdm vdm = new Vdm();
		Assert.assertEquals(1, vdm.parse("!AIVDM,2,1,4,A,<02:oP20ABCh@<51C5P31<<P:?2?EB7PDB16693P6?BPI?EBP3?=@E<C,0*78"));
		...
		vdm = new Vdm();
		Assert.assertEquals(1, vdm.parse("!AIVDM,2,1,1,B,53prCH028H5I=0O;W7I<n118>2373F222222220Q000005v:04Bkk3hTVQAp,0*06"));
