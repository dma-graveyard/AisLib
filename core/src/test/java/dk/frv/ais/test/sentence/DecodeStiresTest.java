...
public class DecodeStiresTest {
	...
	public void basicCbTest() throws SentenceException, SixbitException, AisMessageException {
		...
		cbTest("\\1G2:4723,c:1277725288*08\\!AIVDM,2,1,1,A,5775k;02?ujEI8ESL00l4E9<f0pT4lET00000016EPUC;5iD0IPTQCADR0EQ,0*10", 1);
		...
		cbTest("\\1G2:4747,c:1277725299*0A\\!AIVDM,2,1,7,A,53mU2`01mRfTh4ACH01<4hiT000000000000001688>575eUN9Dm841E1DTh,0*69", 1);
		...
		cbTest("^\\1G2:4817,c:1277725345*00\\!ABVDM,2,1,2,A,50:V:ih01dPN1D9L`01@E=B1=@5@Ttp000000016;0<@475;WI4Sm51DQ0C@,0*3C", 1);
	...
	private void cbTest(String line, int expect) throws SentenceException, SixbitException, AisMessageException {
		Vdm vdm = new Vdm();
		int result = vdm.parse(line);
		Assert.assertEquals("vdm parse failed", expect, result);
	}

	private void cbTest(String line) throws SentenceException, SixbitException, AisMessageException {
		cbTest(line, 0);
	}
